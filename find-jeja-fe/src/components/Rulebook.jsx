    ...
    <Container maxWidth="md" sx={{ mt: 5 }}>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          ...
          <Typography variant="body2" sx={{ ml: 2 }} gutterBottom>
            - 맞춘 조는 맞은 대표의 이름표를 떼서 진행자에게 가져오면 <strong>힌트 레벨이 1단계 상승</strong>합니다.
          </Typography>
          <Typography variant="body2" sx={{}} gutterBottom>
          ...
          <Typography variant="body2" sx={{ ml: 2 }} gutterBottom>
            - 맞춘 조는 맞은 사람의 이름표를 떼서 총 2개의 이름표를 진행자에게 가져오면 <strong>힌트 레벨이 1단계 상승</strong>합니다.
          </Typography>
          <Typography variant="body2" gutterBottom>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography variant="body1">
            최종 등수는 <strong>맞춘 시간</strong>과 <strong>남은 정답 기회</strong>로 결정되며 미션 종료 후 발표될 예정입니다. 세부적인 점수 산정 방식 및 등수는 공개되지 않습니다.
          </Typography>
        </AccordionDetails>
      </Accordion>
    </Container>
